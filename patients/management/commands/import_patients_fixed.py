...
class Command(BaseCommand):
    help = 'Import patients from Google Sheets CSV (Fixed Version)'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Importing patients from Google Sheet: {sheet_id}'))
    ...
    def parse_patient_csv(self, csv_text):
        ...
        for i, line in enumerate(lines[1:], start=2):  # Start at 2 for line numbers
            ...
            try:
                ...
                # Based on the headers: "id","fname","lname","address","sex","dob","mobile","emerg_contact","cnic","status","remarks","gurd","father_name","hsb_name","marital_status","created_date","created_by","acode"
                patient = {

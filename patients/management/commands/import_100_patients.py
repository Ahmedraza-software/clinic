...
class Command(BaseCommand):
    help = 'Import 100 patients from Google Sheets into database'

    def handle(self, *args, **options):
        sheet_id = '1fYUdK_cprGPj8UEoZVI38DiqI7P4G_loOXf8Xg62TWc'
        sheet_name = 'Sheet1'
        
        self.stdout.write(self.style.SUCCESS(f'Importing 100 patients from Google Sheet: {sheet_id}'))
        ...
        try:
            ...
            # Only process first 101 lines (header + 100 patients)
            sample_lines = lines[:101]
            sample_text = '\n'.join(sample_lines)

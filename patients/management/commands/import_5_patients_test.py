...
class Command(BaseCommand):
    help = 'Import 5 test patients from Google Sheets into database'

    def handle(self, *args, **options):
        sheet_id = '1fYUdK_cprGPj8UEoZVI38DiqI7P4G_loOXf8Xg62TWc'
        sheet_name = 'Sheet1'
        
        self.stdout.write(self.style.SUCCESS(f'Importing 5 test patients from Google Sheet: {sheet_id}'))
        ...
        try:
            ...
            # Only process first 6 lines (header + 5 patients)
